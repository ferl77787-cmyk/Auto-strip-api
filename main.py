...
<body>
    <div class="stars"></div>
    <div class="container">
        <div class="logo">𝐋𝐔𝐂𝐈𝐅𝐄𝐑</div>
        <div class="name">𝗔𝗣𝗜</div>
        
        <a href="https://t.me/lucifer_adss" target="_blank" class="telegram-link">
        ...
        <div class="footer">© 2026 LUCIFER</div>
    </div>
</body>
</html>
"""
...
if __name__ == '__main__':
    ...
    print(" LUCIFER API -  Payment Gateway 🔥")
    print("=" * 60)
    print(f"🚀 Running on port: {port}")
    print(f"📱 Telegram: https://t.me/lucifer_b0lte")
    print(f"👑 Developer: LUCIFER")
    print(f"🔑 API Key: lucifer-api")
    print("=" * 60)
